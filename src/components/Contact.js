    ...
    return (
        <div className='pb-10'>
            ...
            <div className=' mt-16 flex flex-wrap justify-center md:w-[60vw]'>
                <RoundedBar2 mt={2} ml={2} md={"lg"} icon={
                ...
                } name={"Shivaverma30july@gmail.com"} to={"mailto:shivaverma30july@gmail.com"} text={"red"} />
                <RoundedBar2 mt={2} ml={2} md={"lg"} icon={
                    <svg width="25" height="25" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                } name={"Instagram"} text={"pink"}  to={"https://www.instagram.com/shiva_verma_30?igsh=MTUyZXZzdjdwN3draw%3D%3D&utm_source=qr"}/>
                <RoundedBar2 mt={2} ml={2} md={"lg"} icon={
                    <svg width="25" height="25" viewBox="0 -2 44 44" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                ...
                } name={"Linkedin"} text={"blue"} to={"https://www.linkedin.com/in/shiva-verma-573002209?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"}/>
                <RoundedBar2 mt={2} ml={2} md={"lg"} icon={
                ...
                } name={"facebook"} to={"https://www.facebook.com/profile.php?id=100085956841113"} text={"blue"} />
                <RoundedBar2 mt={2} ml={2} md={"lg"} icon={
                ...
                } name={"Github"} to={"https://github.com/Shiva-302004/"} text={"black"} />
            </div>
            </div>
            <div className='mt-12 p-2 m-4 rounded-lg  flex justify-center items-center  '>
                <Form/>
            </div>
